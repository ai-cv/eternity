# from https://blog.csdn.net/lbship/article/details/79721480
# quote https://zhuanlan.zhihu.com/p/29519040
# data http://quotes.money.163.com/trade/lsjysj_600570.html?year=2018&season=1
...
# data = pd.DataFrame(pd.read_csv('test/data/600570.csv', sheet_name=1, index_col='日期'))  # 读取数据、设置日期为index
data = pd.DataFrame(pd.read_csv('../test/data/600570.csv', encoding='unicode_escape'))  # 读取数据、设置日期为index
